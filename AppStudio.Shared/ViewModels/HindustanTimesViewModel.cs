...
{
    public class HindustanTimesViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "HindustanTimesDataSource"; }
        }
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("HindustanTimesDetail", item);
                        });
                }
        ...
        {
            return new HindustanTimesDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("HindustanTimesDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("HindustanTimesList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("HindustanTimesDetail");
        }
    }
}
