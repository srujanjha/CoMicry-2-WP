...
{
    public class TimesOfIndiaViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "TimesOfIndiaDataSource"; }
        }
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("TimesOfIndiaDetail", item);
                        });
                }
        ...
        {
            return new TimesOfIndiaDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("TimesOfIndiaDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("TimesOfIndiaList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TimesOfIndiaDetail");
        }
    }
}
